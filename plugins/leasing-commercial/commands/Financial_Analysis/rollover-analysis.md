...
**Save to**: `${CLAUDE_PLUGIN_ROOT}/skills/portfolio-strategy-advisor/scripts/Rollover_Analysis/rollover_inputs/YYYY-MM-DD_HHMMSS_[portfolio_name].json`
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/portfolio-strategy-advisor/scripts/Rollover_Analysis/rollover_calculator.py \
  ${CLAUDE_PLUGIN_ROOT}/skills/portfolio-strategy-advisor/scripts/Rollover_Analysis/rollover_inputs/YYYY-MM-DD_HHMMSS_[portfolio_name].json
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/portfolio-strategy-advisor/scripts/Rollover_Analysis/report_generator.py \
  ${CLAUDE_PLUGIN_ROOT}/skills/portfolio-strategy-advisor/scripts/Rollover_Analysis/rollover_inputs/YYYY-MM-DD_HHMMSS_[portfolio_name].json \
...
1. **Input JSON**: `${CLAUDE_PLUGIN_ROOT}/skills/portfolio-strategy-advisor/scripts/Rollover_Analysis/rollover_inputs/YYYY-MM-DD_HHMMSS_[portfolio].json`
2. **Results JSON**: `${CLAUDE_PLUGIN_ROOT}/skills/portfolio-strategy-advisor/scripts/Rollover_Analysis/rollover_inputs/YYYY-MM-DD_HHMMSS_[portfolio]_results.json`
3. **Markdown Report**: `$CLAUDE_PROJECT_DIR/Reports/YYYY-MM-DD_HHMMSS_rollover_analysis_[portfolio].md`

## Methodology Reference

See `${CLAUDE_PLUGIN_ROOT}/skills/portfolio-strategy-advisor/scripts/Rollover_Analysis/README.md` for:
